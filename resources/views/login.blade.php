...
<head>
    ...
    <title>Login | Medtronix Systems</title>
...
<body style="background: #181144">

    <div class="page">
        <div class="container">
            <div class="left">
                <div class="login">Medtronix Systems</div>
                <div class="eula">Let us help your business thrive in this digital age </div>
            </div>
            <div class="right">
