...
<main role="main" class="main-content">
    <div class="card p-4 my-4">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('employee.updatePicture') }}" method="post"
    ...
    <div class="card p-4 my-4">
        <div class="row">
            <div class="col-12">
                ...
                <form action="{{ route('employee.profile.link') }}" method="post">
                    @csrf
    ...
    <div class="card p-4 my-4">
        ...
        <form action="{{ route('employee.reset.password') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
