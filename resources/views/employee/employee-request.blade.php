                ...
                <div class="col-sm-12 h-auto" style="height: auto">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('mobile.request.store') }}" method="POST">
                                @csrf
                                ...
                                <tbody>
                                    @foreach ($requests->sortByDesc('created_at') as $request)
                                        <tr >
                                            ...
                                            <td>
                                                <a class="btn btn-outline-light" href="{{ route('mobile.request.view', base64_encode($request->id)) }}"><i class="fa fa-eye text-dark" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
