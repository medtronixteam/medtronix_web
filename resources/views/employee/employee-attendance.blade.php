        ...
        <div class="card p-4 my-4">
            <div class="row justify-content-between align-items-center">
                @if (!empty($monthData) && isset($monthData[0]))
                    <h1 class="py-4 col-md-4"> {{ \Carbon\Carbon::parse($monthData[0]['attendance_date'])->format('M,Y') }}
                        Attendances <p class="h3">({{ $monthData[0]->employee->name }})</p>
                    </h1>
                @else
                    <h1 class="py-4 col-md-6">No Attendance Data Available</h1>
                @endif
                <div class="col-md-6 d-print-none">
                    <div class="d-flex justify-content-end w-100">
                        <button onclick="window.print()" type="button" class="btn btn-dark d-print-none px-4">Print</button>
                    </div>
                    <div class="form-row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mt-3">
                    <div class="card p-3">
                        <h4>Yearly leaves available: <span class="badge badge-info">{{ $yearlyLeavesAvailable }}</span></h4>
                    </div>
                </div>
            </div>
