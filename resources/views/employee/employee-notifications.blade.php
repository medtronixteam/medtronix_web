        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="m-portlet m-portlet--full-height">
                    <div class="m-portlet__head" style="    background-image: linear-gradient(310deg, #7928CA 0%, #FF0080 100%);
                    ...
                    <div>
                        <div class="row">
                            <div class="col-12 px-4 py-3">
                                ...
                                <div class="mb-2">
                                    <a id="{{ $notification->id }}" class="newstext m--font-bolder h5" href="{{ $notification->link }}" target="_blank">{{ $notification->heading }}</a>
                                </div>
