...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;background-color:black" id="bodyTable">
	<tbody>
		<tr>
									...
									<tbody>
										...
										<tr>
											<td style="padding-bottom: 30px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="subTitle">
												<h4 class="text" style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;text-align:center;padding:0;margin:0">Check In Missing</h4>
											</td>
										</tr>
										<tr>
														...
														<tr>
															<td style="padding-bottom: 20px;" align="center" valign="top" class="description">
																<p class="text" style="color:#666;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;text-align:center;padding:0;margin:0">
                                                                    Hi fellow how's day going . I found that you did not mark the check in .You have missed your
                                                                    check-in !  it can affects your daily tracking and accountability.
                                                                        <br>
                                                                    It's crucial that you
                                                                    check in on time every day to ensure that all pending tasks are recorded and completed accurately. If this
                                                                    continues,  it could lead to significant consequences, including potential disciplinary action.
                                                                    don't forget to
                                                                    inform HR .
