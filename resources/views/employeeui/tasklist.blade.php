                            ...
                            <div class="card-body" style="max-height: 330px; overflow-y: auto">
                                ...
                                <div class="mt-3">
                                    <p><strong>HR Approval:</strong>
                                        <div class=" @if($task->approved_by_hr == 1)  @elseif($task->approved_by_hr == 2)  @elseif($task->approved_by_hr == 3)   @endif">
                                    ...
                                    <p><strong>Team Lead Approval:</strong>
                                        <div class=" @if($task->approved_by_team_lead == 1) @elseif($task->approved_by_team_lead == 2) @elseif($task->approved_by_team_lead == 3)  @endif">
