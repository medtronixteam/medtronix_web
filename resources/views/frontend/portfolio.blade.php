<x-head />
  ...
  <!--=============== Header end ===============-->
  <!-- ============Hero Section start============== -->
    <div class="mt-md-0 mt-5" data-aos="fade-down"
    data-aos-easing="linear"
    data-aos-duration="1500">
        <img class="img-fluid d-md-flex d-none" src="{{ url('frontend/assets/images/home/meet-our-ceo.png') }}">
        <img class="img-fluid d-md-none d-block" src="{{ url('frontend/assets/images/home/meet-our-ceo-responsive.png') }}">
    </div>
</section>
  <!-- ============Hero Section end============== -->
