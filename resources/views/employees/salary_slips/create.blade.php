        ...
        <div class="card p-4 my-4">
            <div class="row">
                <div class="col-12">
                    ...
                    <h5>Name : <span class="text-info">{{ $employData->name }}</span></h5>
                    <h5>Email : <span class="text-info">{{ $employData->email }}</span></h5>
                    <h5>Phone : <span class="text-info">{{ $employData->phone }}</span></h5>
                </div>
            </div>
        </div>
        <div class="card p-4 my-4">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ route('salary_slips.store') }}" id="salary_form">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <select name="employee_id" id="" class="form-control">
                                    @foreach ($employeesAll as $employee)
                                        <option {{ $employData->id == $employee->id ? 'selected' : '' }}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="salary_month" id="salary_month" class="form-control" required>
                                        @for ($month = 1; $month <= 12; $month++)
                                            ...
                                            @endphp
                                            <option value="{{ $month }}"
                                                {{ $isMonth == $monthDate->format('F') ? 'selected' : '' }}>
                                                {{ $monthDate->format('F') }}
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="0" name="transport_allowance" id="transport"
                                ...
                                <div id="add_allowances_div">
                                    <div data-id='1' class="row form-group">
                                        <div class="col-6 pr-0">
                                            <input type="text" placeholder="Enter Text" name="other_allowance_name[]"
                                                class="form-control">
                                        </div>
                                        <div class="col-4 p-0">
                                            <input type="number" value="0" placeholder="Enter Amount"
                                                name="other_allowance_amount[]" class="form-control">
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="salary_year" id="salary_year" value="{{ now()->year }}"
                                        class="form-control" required>
                                    @error('salary_year')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <label for="income_tax">Income Tax (PKR)</label>
                                    <input type="number" value="0" name="income_tax" id="income_tax"
                                        class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="absent_deduction">Absent Deduction</label>
                                    <input type="number" value="0" name="absent_deduction" id="absent_deduction"
                                        class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="add_deduction_div">
                                    <div data-id='1' class="row form-group">
                                        ...
                                        <div class="col-4 p-0">
                                            <input type="number" value="0" placeholder="Enter Amount"
                                                name="other_deduction_amount[]" class="form-control">
                                        </div>
                                        <div class="col-2 p-0"></div>
                                    </div>
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="total_salary" name="total_salary" class="form-control"
                                    readonly>
                            </div>
                        </div>
                        <input type="hidden" name="print" value="0">
                        <button type="button" id="print_salary_btn" class="btn btn-dark mx-2">Create and Print</button>
                        <button type="submit" id="salary_btn" class="btn btn-primary">Create</button>
                    </form>
