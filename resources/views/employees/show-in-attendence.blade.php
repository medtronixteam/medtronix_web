...
<main role="main" class="main-content">
    ...
    <div class="card p-4 my-4">
        <h3 class="py-4">Show in Attendence</h3>
            ...
            <table id="" class="table table-striped text-dark table-hover dataTable">
                <thead>
                    <tr>
                        ...
                        <th style="color: rgb(0, 26, 78); font-weight:800; ">Show in Attendence </th>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input data-id="{{ $employee->id }}"  type="checkbox" class="toggle-class"
                                               ...
                                               {{ $employee->show_in_attendence ? 'checked' : '' }}>
                                    </label>
...
<script>
    $(document).ready(function() {
        $('.toggle-class').change(function() {
            var ShowInEttendence = $(this).prop('checked') ? 1 : 0;
            var memberId = $(this).data('id');

            $.ajax({
                type: "GET",
                dataType: "json",
                url: "{{ route('update.employee.attendence') }}",
                data: {'ShowInAttendence': ShowInEttendence, 'member_id': memberId},
